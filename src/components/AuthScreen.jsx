  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-1">Organize Yourselves</h1>
        <p className="text-sm text-gray-500 mb-8">Sign in to sync your data across devices</p>
